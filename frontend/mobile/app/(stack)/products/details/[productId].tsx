...
import mycart from '@/app/cart/mycart';
...
export default function ProductDetails() {
  ...
  useEffect(() => {
    ...
    console.log('WE HAVE A ProductId? ', productId)
  ...
  const imageSource = imageMapper[product.imageUrl] || require("../../../../assets/images/placeholder.png");
